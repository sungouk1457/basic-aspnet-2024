...
- ASP.NET
    ...
    - ASP.NET Core 웹앱(Model-View-Controller)
        ...
        - MVC 개념도
            ...
            <img src="https://raw.githubusercontent.com/sungouk1457/basic-aspnet-2024/main/images/an0002.png" width="730">
...
- ASP.NET Core 웹사이트, MyPortfolio
    ...
    <img src="https://raw.githubusercontent.com/sungouk1457/basic-aspnet-2024/main/images/an0004.png" width="500">

## 10일차
- ASP.NET Core 웹사이트, MyPortfolio
    1. Board.cs 멤버속성 ModeDate -> ModDate
        - BoardController.cs에서 ModeDate -> ModDate 변경
        - Views/Board/*.cshtml에서 ModeDate -> ModDate 변경
    2. ASP.NET Core 템플릿으로 만들어주는 CRUD(Insert, Select, Update, Delete)
    3. 테이블 삭제, 재생성
    4. 게시판 관련된 화면 수정작업
        - Views/Board/Index.cshtml 게시판 리스트화면 수정
        - Index.cshtml 테이블틀 변경, 삭제, 수정, 상세버튼 삭제
    ...
    6. 웹사이트 동작순서
        1. https://localhost:7154/Board/Create 링크를 오픈
        2. BoardController -> Create 액션메서드 발동
        3. Sumbit -> BoardController -> Create 액션메서드 발동
...
- ASP.NET Core 웹사이트, MyPortfolio
    ...
    5. 검색
        ...
        https://github.com/user-attachments/assets/267e22d4-7094-441e-a79c-919e53793ec6
...
- ASP.NET Core 웹사이트, MyPortfolio
    ...
    2. 회원가입, 로그인...
        ...
        4. Add-Migration, Upadte-Database 실행
        5. Program.cs에 로그인 세션
